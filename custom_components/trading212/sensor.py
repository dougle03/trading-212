...
SENSOR_DESCRIPTIONS: tuple[Trading212SensorEntityDescription, ...] = (
    Trading212SensorEntityDescription(
        ...
        attributes_key="account_value_attrs",
    ...
    Trading212SensorEntityDescription(
        ...
        attributes_key="free_funds_attrs",
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
    ),
    Trading212SensorEntityDescription(
        ...
        value_key="invested",
        attributes_key="invested_attrs",
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
    ),
    Trading212SensorEntityDescription(
        key="holdings_value",
        translation_key="holdings_value",
        value_key="holdings_value",
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
    ),
    Trading212SensorEntityDescription(
    ...
    Trading212SensorEntityDescription(
        key="account_change",
        translation_key="account_change",
        value_key="account_change",
        attributes_key="account_change_attrs",
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        feature_option=FEATURE_MOVERS_DAILY,
    ),
    Trading212SensorEntityDescription(
        key="account_change_percent",
        translation_key="account_change_percent",
        value_key="account_change_percent",
        attributes_key="account_change_percent_attrs",
        native_unit_of_measurement=PERCENTAGE,
        state_class=SensorStateClass.MEASUREMENT,
        feature_option=FEATURE_MOVERS_DAILY,
    ),
    ...
    Trading212SensorEntityDescription(
        key="total_pies_total_value_including_cash",
        translation_key="total_pies_total_value_including_cash",
        value_key="total_pies_total_value_including_cash",
        attributes_key="total_pies_total_value_including_cash_attrs",
        device_class=SensorDeviceClass.MONETARY,
        state_class=SensorStateClass.TOTAL,
        feature_option=FEATURE_PIES_SUMMARY,
    ),
